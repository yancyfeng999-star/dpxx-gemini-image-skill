#!/usr/bin/env python3
"""Generate Gemini images via RootFlowAI (text-to-image / image-to-image)."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Generate images with RootFlowAI Gemini models.")
    ...
    parser.add_argument("--model",
                        help=("Model name. Gemini: gemini-3.1-flash-image-* or gemini-3-pro-image-*. "
    ...
    parser.add_argument("--quality", default=DEFAULT_QUALITY,
                        ...
                        help="Accepted for CLI compatibility, but omitted for Gemini requests.")
